...
def renomear_itens(caminho, caracteres, inicio_do_final, recursivo):
    ...
    for item in itens:
        ...
        # Ajuste para começar a contar do final
        inicio = len(nome_base) - inicio_do_final
        parte_para_excluir = nome_base[inicio:inicio + caracteres]
        nome_renomeado = nome_base[:inicio] + nome_base[inicio + caracteres:] + extensao
        ...
        print(f"{nome_base[:inicio]}{Back.YELLOW}{parte_para_excluir}{Back.RESET}{nome_base[inicio + caracteres:]}{extensao}")
...
def main():
    ...
    inicio = int(input("A partir de qual caracter do final deseja começar? "))
